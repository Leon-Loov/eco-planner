  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        ...
        <input list="actors" id="actor" name="actor" defaultValue={currentRoadmap?.actor ?? undefined} />
        ...
        <input type="submit" value={currentRoadmap ? "Spara" : "Skapa färdplan"} className="call-to-action-primary" />
      </form>
